...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //controller.salvarProprietario("11144433311", "Genix", "5571988886666", "Somália", "genesisx@hotmail.com");
            //controller.atualizarProprietario("11144433300", "Genix", "71988886666", "Somália", "genesisx@hotmail.com");
            ...
            //controller.atualizarVeterinario("SP-34569", "Juliah", "Ortopedista", "5511966665599");
            
            //controller.deletarVeterinario(1);
            
            System.out.println("\nCriando animais");
            //nome, especie, raca, data_nasc, peso, proprietario_id
            controller.salvarAnimal("Treme-treme", "Cachorro", "Pinsher", LocalDate.of(2018, 6, 12), 4.5, 2);
            ...
            //controller.atualizarAnimal(2, "Wukong", "Macaco", "Prego", LocalDate.of(2023, 8, 23), 6.2, 3);
            
            //controller.deletarAnimal(3);
            
            //controller.deletarProprietario(1);
            ...
            //controller.salvarConsulta(LocalDateTime.of(2024, 7, 26, 20, 15), "Melhora", 50, 3, 2);
            
            
            //idConsulta, dataHora, diagnostico, valor, animalId, veterinario_id
            //controller.atualizarConsulta(2, LocalDateTime.of(2024, 9, 24, 11, 20), "Perda total", 25, 1, 2);
