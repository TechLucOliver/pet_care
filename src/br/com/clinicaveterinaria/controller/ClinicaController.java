...
public class ClinicaController {
    ...
    /////////////////////////////////////////////////////////
 	...
 	//METODOS ANIMAIS////////////////////////////////////
    public void salvarAnimal(String nome, String especie, String raca, LocalDate dataNasc, double peso, int proprietario_id) {
    ...
    public void atualizarAnimal(int idAnimal, String nome, String especie, String raca, LocalDate dataNasc, double peso, int proprietario_id) {
        Animal animal = new Animal(nome, especie, raca, dataNasc, peso, proprietario_id);
        animal.setIdAnimal(idAnimal); // Define o ID para o UPDATE saber quem atualizar
    ...
    //METODOS CONSULTAS////////////////////////////////////
    public void salvarConsulta(LocalDateTime dataHora, String diagnostico, double valor, int animalId, int veterinario_id) {
	...
	public void atualizarConsulta(int idConsulta, LocalDateTime dataHora, String diagnostico, double valor, int animalId, int veterinario_id) {
		Consulta consulta = new Consulta(dataHora, diagnostico, valor, animalId, veterinario_id);
